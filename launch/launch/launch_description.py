...
class LaunchDescription(LaunchDescriptionEntity):
    ...
    def get_launch_arguments_with_include_launch_description_actions(
        self, conditional_inclusion: bool = False, only_search_local=False
        ...
        def process_entities(entities, *, _conditional_inclusion: bool, nested_ild_actions=None, only_search_local=False):
